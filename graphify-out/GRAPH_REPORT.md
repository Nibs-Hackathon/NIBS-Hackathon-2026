...
Cohesion: 0.12
Nodes (8): BackendAPI, Get health for a specific asset., Get Gemini-generated thresholds for an asset type., Get Gemini-generated workflow sequence., Single interface for frontend to access backend data with caching., Get current simulation status., Lazy load runtime to avoid circular imports., Get all refineries with their assets.
...
Cohesion: 0.11
Nodes (18): calculate_severity(), get_incidents(), Incident adapter with dynamic severity calculation from config., Trigger an incident and return formatted results., Get all incidents from the runtime., Calculate severity from event payload using dynamic thresholds from AI config., trigger_incident(), calculate_severity() (+10 more)
...
Cohesion: 0.10
Nodes (13): backend/agents, backend/data/ai_config.json, Folder: backend/data Code Inventory, backend/data, backend/models, backend/rag, backend, Subfolders (+5 more)
...
### Community 123 - "Project_Code_Inventory_By_Folder/frontend/src/design-system/README.md"
Cohesion: 0.20
...
### Community 220 - "redesign/FILES.md"
Cohesion: 0.29
...
### Community 242 - "tools/FILES.md"
Cohesion: 0.40
Nodes (3): backend/mao/tools/tool_registry.py, Folder: backend/mao/tools Code Inventory, backend/mao/tools

### Community 243 - "hooks/FILES.md"
Cohesion: 0.40
Nodes (3): Folder: frontend/src/hooks Code Inventory, frontend/src/hooks/useWebSocket.js, frontend/src/hooks
