# Graph Report - rigos-hackathon-2026  (2026-07-27)

## Corpus Check
- 331 files · ~177,583 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2459 nodes · 4301 edges · 211 communities (177 shown, 34 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 218 edges (avg confidence: 0.52)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `6afbfc19`
...
- AgentRegistry
- scripts
- frontend_services/incident_adapter.py
- ConnectionManager
...
- Project_Code_Inventory_By_Folder/frontend/src/design-system/README.md
...
2. `AgentResult` - 40 edges
3. `AIConfigGenerator` - 36 edges
4. `BackendAPI` - 34 edges
5. `BackendAPI` - 33 edges
6. `ComputationEngine` - 33 edges
7. `get_session()` - 32 edges
8. `LLMManager` - 29 edges
9. `Folder: frontend/src/redesign Code Inventory` - 29 edges
10. `Task` - 28 edges
...
### Community 0 - "catalog/index.js"
Cohesion: 0.08
Nodes (67): DecisionButtonGroup(), FilterChipBar(), PrimaryCTA(), RationaleField(), ScenarioSlider(), EmptyState(), ForecastChart(), HealthRing() (+59 more)

### Community 1 - "KeyStatus"
Cohesion: 0.10
...
Cohesion: 0.06
Nodes (32): clamp(), tone(), V2AIAgentCard(), V2AlertChip(), V2FacilityNode(), V2HealthRing(), V2ProgressIndicator(), V2RecommendationCard() (+24 more)

### Community 3 - "adapters/__init__.py"
Cohesion: 0.05
Nodes (40): get_agent_metrics(), get_agents(), Agent adapter using BackendAPI., Return monitor metrics calculated from the live state., Return registered agents and their latest execution state., get_assets(), Asset adapter using BackendAPI., Get all assets with telemetry history. (+32 more)
...
### Community 5 - "main.py"
Cohesion: 0.11
Nodes (35): list_asset_notes(), create_maintenance_work_order(), database_health(), export_report(), get_agent_activity(), get_agent_metrics(), get_agents(), get_asset_detail() (+27 more)

### Community 6 - "Task"
Cohesion: 0.14
Nodes (19): Event, BaseModel, BaseModel, Task, FlowWorkflow, GasWorkflow, intelligence_tasks(), Reusable intelligence stages appended to established operational workflows. (+11 more)

### Community 7 - "simulator.py"
Cohesion: 0.19
Nodes (8): Notification, NotificationService, NotificationSeverity, NotificationType, Enum, str, Real-time notification service., Simulator with proper incident cooldown and rate limiting.

### Community 8 - "layouts/index.js"
Cohesion: 0.08
Nodes (41): getOperationsLive(), App(), createProductTheme(), PRODUCT_PATHS, RoutedApp(), ApplicationShell(), nav, ColorModeContext (+33 more)

### Community 9 - "AgentResult"
Cohesion: 0.11
Nodes (20): Agent, ABC, Every agent must return an AgentResult., Production Diagnostic Agent with dynamic thresholds., Knowledge agent shared by MAO workflows and Command Nexus., Production Maintenance Agent with dynamic priority levels., Runtime notification agent with dynamic severity levels., Production Planning Agent with Gemini-generated sequences. (+12 more)

### Community 10 - "ActionDB"
Cohesion: 0.08
Nodes (26): KnowledgeSearchError, RuntimeError, Raised when the registered knowledge retrieval path is unavailable., approve_maintenance_work_order(), AssetNoteRequest, AssistantQuery, mark_notifications_read(), MockAssetService (+18 more)

### Community 11 - "views/shared.jsx"
Cohesion: 0.16
Nodes (15): approveWorkOrder(), getMaintenancePlan(), navigateTo(), ExportAuditButton(), MetricWithProvenance(), MaintenancePlanning(), normalizeTask(), MissionControlOS() (+7 more)

### Community 12 - "ProductPage.jsx"
Cohesion: 0.10
Nodes (20): assetLocation(), filterByFacility(), incidentLocation(), PATH_ALIASES, taskLocation(), WORKSPACE_LABELS, WORKSPACE_PATHS, inferProvenance() (+12 more)

### Community 13 - "AIConfigGenerator"
Cohesion: 0.11
Nodes (13): AIConfigGenerator, Generate all configuration using AI once at startup., Parse JSON from AI response., Return default configuration., Save config to file for cache., Get the generated configuration., Get config for a specific asset type., Get thresholds for a specific asset type. (+5 more)

### Community 14 - "client.js"
Cohesion: 0.14
Nodes (4): api, askAssistant(), Assistant(), prompts

### Community 15 - "ProductShell.jsx"
Cohesion: 0.24
Nodes (13): markNotificationsRead(), facilityOptionsFromRefineries(), useObjectContext(), pathToWorkspace(), exportAuditLog(), mapAuditEvents(), useOperatorAudit(), AssistantPanel() (+5 more)

### Community 16 - "ConfigService"
Cohesion: 0.09
Nodes (18): Incident adapter with dynamic severity calculation from config., AI Configuration Generator - Runs once on startup to generate all thresholds and, ConfigService, Get thresholds - uses precomputed values for speed., Generate agent sequence for an incident type., Generate and cache operational configurations using Gemini., Generate priority level for an incident., Generate risk weights for different sensors. (+10 more)

### Community 17 - "AssetConsole.jsx"
Cohesion: 0.20
Nodes (18): getAssetHealth(), getAssetNotes(), getTwinAssets(), saveAssetNote(), searchKnowledge(), AssetBottomWorkspace(), AssetConsole(), AssetExplorer() (+10 more)

### Community 18 - "models.py"
Cohesion: 0.12
Nodes (14): _ensure_vector_extension(), Development-only schema bootstrap. Production uses Alembic migrations., Return True when pgvector is available for the knowledge table., cached_query(), clear_cache(), get_session_context(), healthcheck(), Optimized database connection with pooling and query caching. (+6 more)

### Community 19 - "Asset"
Cohesion: 0.27
Nodes (10): Asset, AssetStatus, AssetType, BaseModel, Enum, str, Refinery, Generate multiple refineries with hundreds of assets. (+2 more)

### Community 20 - "datetime"
Cohesion: 0.16
Nodes (24): _action_step(), _agent_step(), get_execution_report_export(), get_execution_reports(), get_incident_audit(), get_incident_audit_detail(), get_live_investigation(), get_operations_live() (+16 more)

### Community 21 - "NeonVectorStore"
Cohesion: 0.10
Nodes (10): KnowledgeIngestion, NeonVectorStore, Search by embedding vector., Return self for compatibility., Return a retriever interface., Create the vector store from a list of documents., Add documents to an existing vector store., Remove all indexed chunks. (+2 more)

### Community 22 - "Path"
Cohesion: 0.21
Nodes (19): Read-only Knowledge Base access through the shared MAO kernel., Return normalized Neon retrieval results from the registered KnowledgeAgent., search_knowledge(), Path, clear_out_dir(), fence_lang(), folder_readme(), inventory_markdown() (+11 more)

### Community 23 - "computation_engine.py"
Cohesion: 0.16
Nodes (11): BaseModel, Enum, str, Sensor, SensorType, Real-time computation engine - Runs every 10-15 seconds., Health service using the computation engine with AI-generated thresholds., Manual incident injection for the shared live simulator. (+3 more)

### Community 24 - "SimulatorController"
Cohesion: 0.15
Nodes (6): get_simulator(), Lazy-initialize and return the shared simulator., Any, Optimized Simulator controller - NO circular imports., Controls the simulation lifecycle with UI integration and auto-refresh., SimulatorController

### Community 25 - "dependencies"
Cohesion: 0.11
Nodes (19): animejs, axios, @emotion/react, @emotion/styled, dependencies, animejs, axios, @emotion/react (+11 more)
...
### Community 27 - "get_session"
Cohesion: 0.13
Nodes (24): Asset note persistence helpers., Replace the latest note for an asset (single active note per asset for UI)., upsert_asset_note(), approve_work_order(), create_work_order(), get_maintenance_plan(), _persisted_work_orders(), _priority_label() (+16 more)

### Community 28 - "kernel.py"
Cohesion: 0.16
Nodes (8): ExecutionContext, Register an agent result and update execution state., ExecutionReport, BaseModel, Orchestrator, Orchestrator with deterministic, dependency-safe agent execution., Aggregates all agent outputs into a final execution decision., Supervisor
...
### Community 30 - "IncidentManagement.jsx"
Cohesion: 0.20
Nodes (16): getIncidentAuditDetail(), timelineFromAudit(), readWorkspace(), useWorkspace(), WorkspaceContext, WorkspaceProvider(), buildEvidenceFacts(), DecisionHistory() (+8 more)

### Community 31 - "._record_execution_sync"
Cohesion: 0.28
Nodes (3): IncidentDB, IncidentRepository, Sync version for execution.
...
Cohesion: 0.14
Nodes (7): BackendAPI, Get health for a specific asset., Single interface for frontend to access backend data with caching., Get Gemini-generated thresholds for an asset type., Get Gemini-generated workflow sequence., Get current simulation status., Lazy load runtime to avoid circular imports.

### Community 35 - "adapters/agent_activity_adapter.py"
Cohesion: 0.12
Nodes (19): _format_time(), get_agent_activity(), get_agent_metrics(), _persisted_activity(), Activity view-model sourced from live MAO state and persisted audit events., Load immutable activity records without blocking live state rendering., Return the combined live MAO and persisted activity timeline., Return summary metrics from current MAO agent results. (+11 more)

### Community 36 - "BackendAPI"
Cohesion: 0.12
Nodes (8): BackendAPI, Get health for a specific asset., Single interface for frontend to access backend data with caching., Get Gemini-generated thresholds for an asset type., Get Gemini-generated workflow sequence., Get current simulation status., Lazy load runtime to avoid circular imports., Get all refineries with their assets.
...
### Community 39 - "TelemetryRepository"
Cohesion: 0.18
...
Cohesion: 0.12
Nodes (6): PDFLoader, DocumentLoader, RAGPipeline, Build a FAISS vector store from PDF files., DocumentSplitter, VectorStore
...
### Community 44 - "_LocalVectorStore"
Cohesion: 0.15
Nodes (9): AssetDB, AssetRepository, Optimized Asset Repository with batch operations., Batch insert for better performance., Bulk update asset health in one query., _LocalVectorStore, _persist_assets_to_database(), Empty retrieval store used by the isolated demo runtime. (+1 more)

### Community 45 - "models/base.py"
Cohesion: 0.24
...
### Community 46 - "services/__init__.py"
Cohesion: 0.15
Nodes (6): get_ai_config(), get_computation_engine(), get_runtime(), Services module exports - NO circular imports., Get the AI Configuration Generator (singleton)., Get the Computation Engine (singleton).

### Community 47 - "IncidentService"
Cohesion: 0.20
Nodes (8): _ApiProxy, _get_api_instance(), Unified backend API for frontend access with caching and refinery support., Trigger an incident and return formatted results., trigger_incident(), IncidentService, Inject operator-requested faults into the shared live simulator., test_pressure_spike_api_name_targets_a_live_asset()
...
Cohesion: 0.19
Nodes (7): Revenue impact calculation service., Calculate revenue impact of a specific incident., Get daily revenue for an asset type., Calculate revenue impact for a single asset., Calculate total revenue impact across all assets., Calculate revenue impact based on asset health and incidents., RevenueService
...
Cohesion: 0.11
Nodes (18): create_schema(), Facility, BaseModel, _auto_simulation_loop(), get_kernel(), _initialize_kernel(), _initialize_simulator(), is_initialized() (+10 more)

### Community 56 - "EventGenerator"
Cohesion: 0.20
...
Cohesion: 0.20
Nodes (4): KnowledgeDB, KnowledgeRepository, Return all knowledge chunks from the database., Delete all knowledge chunks from the database.
...
Cohesion: 0.10
Nodes (10): backend/agents, backend/data/ai_config.json, Folder: backend/data Code Inventory, backend/data, backend/models, backend/rag, backend, Subfolders (+2 more)

### Community 64 - "adapters/backend_api_new.py"
Cohesion: 0.22
Nodes (6): _ApiProxy, _get_api_instance(), _parse_iso(), Unified backend API for frontend access with caching and refinery support., Cached version of get_asset_telemetry., Get telemetry history for an asset; optional ISO since/until window.
...
Cohesion: 0.22
Nodes (8): name, private, scripts, backend, build, dev, lint, preview

### Community 71 - "frontend_services/incident_adapter.py"
Cohesion: 0.40
Nodes (5): calculate_severity(), get_incidents(), Incident adapter with dynamic severity calculation from config., Get all incidents from the runtime., Calculate severity from event payload using dynamic thresholds from AI config.
...
Cohesion: 0.08
Nodes (17): Folder: frontend/src Code Inventory, frontend/src/App.css, frontend/src/App.jsx, frontend/src/index.css, frontend/src/main.jsx, Folder: frontend/src/hooks Code Inventory, frontend/src/hooks/useWebSocket.js, frontend/src/hooks (+9 more)

### Community 76 - "._invalidate_cache"
Cohesion: 0.29
Nodes (3): Trigger a simulated incident., Refresh all configurations and clear caches., Advance simulation by one tick.

### Community 77 - "._invalidate_cache"
Cohesion: 0.29
Nodes (3): Trigger a simulated incident., Refresh all configurations and clear caches., Advance simulation by one tick.
...
Cohesion: 0.08
Nodes (14): backend/mao/core, backend/mao/__init__.py, backend/mao/kernel.py, backend/mao/orchestrator.py, Folder: backend/mao Code Inventory, backend/mao/memory/memory_manager.py, Folder: backend/mao/memory Code Inventory, backend/mao/memory (+6 more)
...
### Community 86 - "frontend_services/health_prediction_adapter.py"
Cohesion: 0.40
...
### Community 87 - "adapters/health_prediction_adapter.py"
Cohesion: 0.40
...
### Community 89 - ".generate_refineries"
Cohesion: 0.33
Nodes (4): Asset, Generate multiple refineries with assets., Generate assets for a refinery., Refinery
...
### Community 95 - "frontend/package.json"
Cohesion: 0.40
...
### Community 124 - "Simulator"
Cohesion: 0.20
Nodes (7): Check if an asset can have a new incident., Trigger a new incident., Send notifications for an incident (only once)., Resolve an active incident., Check if telemetry values have returned to normal range., Run one simulation tick., Simulator
...
### Community 160 - "frontend_services/knowledge_agent_adapter.py"
Cohesion: 0.21
...
### Community 161 - "adapters/knowledge_agent_adapter.py"
Cohesion: 0.21
Nodes (14): ask_knowledge_agent(), _emit(), generate_conversational_response(), get_knowledge_agent(), is_operational_query(), KnowledgeAgentUnavailable, ProgressCallback, RuntimeError (+6 more)

### Community 162 - "Folder: backend/database Code Inventory"
Cohesion: 0.13
...
### Community 172 - "ForecastTerminal.jsx"
Cohesion: 0.30
Nodes (10): createWorkOrder(), getPredictions(), mergeAssetsWithTwin(), normalizePredictionResponse(), normalizeTwinAsset(), parsePercent(), parseRulDays(), ForecastTerminal() (+2 more)
...
Cohesion: 0.18
Nodes (11): Folder: frontend/src/design-system/layouts Code Inventory, frontend/src/design-system/layouts/ApplicationShell.jsx, frontend/src/design-system/layouts/ExecutiveLayout.jsx, frontend/src/design-system/layouts/ExplorerLayout.jsx, frontend/src/design-system/layouts/IncidentLayout.jsx, frontend/src/design-system/layouts/index.js, frontend/src/design-system/layouts/InvestigationLayout.jsx, frontend/src/design-system/layouts/KanbanLayout.jsx (+3 more)

### Community 177 - "persistence.py"
Cohesion: 0.24
Nodes (5): ExecutionReportDB, ReportRepository, get_persistence(), Persistence service with buffer and sync saving., Get the singleton persistence service.
...
Cohesion: 0.36
Nodes (8): exportReport(), getReports(), recordOperatorAction(), downloadReportExport(), downloadTextFile(), ExecutiveBriefing(), formatTime(), Metric()

### Community 180 - "Folder: frontend/src/context Code Inventory"
Cohesion: 0.20
...
### Community 181 - "Project_Code_Inventory_By_Folder/frontend/src/design-system/README.md"
Cohesion: 0.20
Nodes (4): frontend/src/design-system/catalog, frontend/src/design-system/layouts, frontend/src/design-system, Subfolders

### Community 182 - "Design QA lock (must pass before build)"
Cohesion: 0.22
...
### Community 183 - "Part A — Brutal audit of the current Assets page"
Cohesion: 0.22
...
### Community 189 - "Folder: backend/mao/core Code Inventory"
Cohesion: 0.25
Nodes (8): backend/mao/core/context.py, backend/mao/core/exceptions.py, backend/mao/core/executor.py, backend/mao/core/logger.py, backend/mao/core/registry.py, backend/mao/core/scheduler.py, backend/mao/core/state_manager.py, Folder: backend/mao/core Code Inventory

### Community 190 - "Folder: backend/mao/models Code Inventory"
Cohesion: 0.25
...
### Community 191 - "Part J — Deliverables"
Cohesion: 0.29
...
### Community 199 - "Folder: backend Code Inventory"
Cohesion: 0.33
...
### Community 202 - "Base"
Cohesion: 0.40
Nodes (4): ActivityEventDB, AssetNoteDB, Operator shift notes attached to an asset (Phase 3 persistence)., Base

### Community 205 - "Epic 6 — Frontend performance budget"
Cohesion: 0.40
Nodes (4): Epic 6 — Frontend performance budget, Implemented, Measure, Targets

### Community 206 - "src/api/FILES.md"
Cohesion: 0.40
Nodes (3): Folder: frontend/src/api Code Inventory, frontend/src/api/client.js, frontend/src/api

### Community 207 - "calculate_severity"
Cohesion: 0.50
Nodes (4): calculate_severity(), get_incidents(), Get all incidents from the runtime., Calculate severity from event payload using dynamic thresholds from AI config.

### Community 208 - "TaskStatus"
Cohesion: 0.67
Nodes (3): Enum, str, TaskStatus

### Community 209 - "React + Vite"
Cohesion: 0.50
Nodes (3): Expanding the ESLint configuration, React Compiler, React + Vite

### Community 210 - "Project Code Inventory (Updated)"
Cohesion: 0.50
Nodes (4): Areas, Folder index, Layout, Project Code Inventory (Updated)

## Knowledge Gaps
- **586 isolated node(s):** `workspaces`, `name`, `private`, `version`, `type` (+581 more)
...
- **Why does `ConfigService` connect `ConfigService` to `adapters/backend_api_new.py`, `BackendAPI`, `PredictionAgent`, `BackendAPI`, `MaintenanceAgent`, `AgentResult`, `PlanningAgent`, `services/__init__.py`, `IncidentService`, `LLMManager`, `SafetyAgent`, `SimulatorController`, `DiagnosticAgent`, `NotificationAgent`?**
  _High betweenness centrality (0.052) - this node is a cross-community bridge._
- **Why does `MAOKernel` connect `MAOKernel` to `StateManager`, `PersistenceService`, `AgentRegistry`, `Executor`, `Task`, `.__init__`, `AgentResult`, `EventStore`, `Scheduler`, `MemoryManager`, `WorkflowEngine`, `runtime.py`, `kernel.py`, `HealthService`?**
  _High betweenness centrality (0.031) - this node is a cross-community bridge._
- **Why does `LLMManager` connect `LLMManager` to `frontend_services/knowledge_agent_adapter.py`, `adapters/knowledge_agent_adapter.py`, `KeyStatus`, `AgentResult`, `AIConfigGenerator`, `services/__init__.py`, `ConfigService`, `KnowledgeAgent`?**
  _High betweenness centrality (0.031) - this node is a cross-community bridge._
...
- **Are the 2 inferred relationships involving `BackendAPI` (e.g. with `ConfigService` and `IncidentService`) actually correct?**
  _`BackendAPI` has 2 INFERRED edges - model-reasoned connections that need verification._